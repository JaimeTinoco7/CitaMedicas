 ...
 * @author anghy
 */
public class PerfilDraSilvia extends javax.swing.JFrame {

    /**
     * Creates new form PerfilDraSilvia
     */
    public PerfilDraSilvia() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblDraSilvia = new javax.swing.JLabel();
        ...
        lblDraSilvia.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/PerfilDraSilvia.png"))); // NOI18N
        pnlCentral.add(lblDraSilvia, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 70, -1, 680));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PerfilDraSilvia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PerfilDraSilvia().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JLabel lblDraSilvia;
