 ...
 * @author jaime
 */
public class doctorfranciscoperfil extends javax.swing.JFrame {

    /**
     * Creates new form InicioPantalla
     */
    public doctorfranciscoperfil() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/PerfilPsFrancisco.png"))); // NOI18N
        pnlCentral.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 490, 720));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(doctorfranciscoperfil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new doctorfranciscoperfil().setVisible(true);
            }
        });
    }
