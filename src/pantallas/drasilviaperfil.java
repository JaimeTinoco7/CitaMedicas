 ...
 * @author jaime
 */
public class drasilviaperfil extends javax.swing.JFrame {

    /**
     * Creates new form InicioPantalla
     */
    public drasilviaperfil() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/PerfilDraSilvia.png"))); // NOI18N
        pnlCentral.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, 490, 650));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(drasilviaperfil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new drasilviaperfil().setVisible(true);
            }
        });
    }
