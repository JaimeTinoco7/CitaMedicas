 ...
 * @author anghy
 */
public class PerfilDrEdgard extends javax.swing.JFrame {

    /**
     * Creates new form PerfilDrEdgard
     */
    public PerfilDrEdgard() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        pnlCentral.add(lblDrEdgard, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 70, 430, 690));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PerfilDrEdgard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PerfilDrEdgard().setVisible(true);
            }
        });
    }
